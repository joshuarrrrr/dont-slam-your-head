...
CoutOutput3DWrapper::CoutOutput3DWrapper(int width, int height)
{
	this->width = width;
	this->height = height;
...
CoutOutput3DWrapper::~CoutOutput3DWrapper()
{
}


void CoutOutput3DWrapper::publishKeyframe(Frame* f)
{
...
void CoutOutput3DWrapper::publishTrackedFrame(Frame* kf)
{
	/*lsd_slam_viewer::keyframeMsg fMsg;
...
void CoutOutput3DWrapper::publishKeyframeGraph(KeyFrameGraph* graph)
{
...
void CoutOutput3DWrapper::publishTrajectory(std::vector<Eigen::Matrix<float, 3, 1>> trajectory, std::string identifier)
{
	// unimplemented ... do i need it?
}

void CoutOutput3DWrapper::publishTrajectoryIncrement(Eigen::Matrix<float, 3, 1> pt, std::string identifier)
{
	// unimplemented ... do i need it?
}

void CoutOutput3DWrapper::publishDebugInfo(Eigen::Matrix<float, 20, 1> data)
{
